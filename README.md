...
This repository currently contains product and research documentation only. It has no application, installation process, or production-ready features.
...
The project is intended to be available under the MIT License. The repository should include the corresponding license text before its first release.

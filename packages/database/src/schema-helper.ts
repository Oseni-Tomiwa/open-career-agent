...
export function getTables(handle: DatabaseHandle) {
  if (handle.engine === 'postgres') {
    return {
      ...
      requirementSets: pgSchema.requirementSetsPg,
      canonicalRequirements: pgSchema.canonicalRequirementsPg,
      requirementProvenance: pgSchema.requirementProvenancePg,
      requirementAssistanceRuns: pgSchema.requirementAssistanceRunsPg,
      requirementCandidates: pgSchema.requirementCandidatesPg,
      requirementCandidateSources: pgSchema.requirementCandidateSourcesPg,
  ...
  return {
    ...
    requirementSets: sqliteSchema.requirementSets,
    canonicalRequirements: sqliteSchema.canonicalRequirements,
    requirementProvenance: sqliteSchema.requirementProvenance,
    requirementAssistanceRuns: sqliteSchema.requirementAssistanceRuns,
    requirementCandidates: sqliteSchema.requirementCandidates,
    requirementCandidateSources: sqliteSchema.requirementCandidateSources,
